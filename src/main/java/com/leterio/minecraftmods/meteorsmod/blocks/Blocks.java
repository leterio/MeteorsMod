...
public final class Blocks {
	...
	// public static final BlockBase BLOCK_KREKNORITE_ORE = new BlockBase("kreknorite_ore", Material.IRON); // TODO
	...
	// RED GEM
	public static final BlockBase BLOCK_RED_GEM_BLOCK = new BlockBase("red_gem_block", Material.IRON);
